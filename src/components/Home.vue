<template>
  ...
  <b-col lg="6" class="p-3 pb-5">
    ...
    <p class="text-justify">
      In addition to her own work Will has collaborated and danced with Sara Shelton Mann, Rosy Simas, Aniccha Arts (Pramila Vasudevan), Deborah Jinza Thayer, Blake Nellis, Tim Rehborg, Off Leash Area, Vanessa Voskuil, Body Cartography Project and Miguel Gutierrez among others. Will maintains a private healing practice blending modalities of healing justice work with developmental psychotherapy and somatic bodywork.
    </p>
    <p class="text-justify">
